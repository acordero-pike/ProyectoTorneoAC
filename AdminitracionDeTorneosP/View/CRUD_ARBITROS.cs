...
namespace AdminitracionDeTorneosP.View
{
    public partial class refereeView : Form
    {
            ...
            else if(action == 0)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        refereeDB.updateReferee(dpi, name, lastname, address, phone, nacionality, birthDate, email, role);
                        action = 1;
                        //Refrescar dats 
                        refereeList.DataSource = refereeDB.getRefereee();
                        //limpiar campos 
        ...
        private void refereeView_Load(object sender, EventArgs e)
        {
