...
namespace AdminitracionDeTorneosP.View
{
    public partial class CRUD_REGISTRO_AMONESTACION : Form
    {
        ...
        public CRUD_REGISTRO_AMONESTACION(int Id_Juegoo)
        {
            ...
            LIstAmonestaciones .ReadOnly = true;
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            switch (accion)
            {
                //1 = Guardar
                case 1:
                    if (cmbEquipos.SelectedIndex<0 || cmbJugador.SelectedIndex<0 || cmbTarjeta.SelectedIndex<0|| txtTiempo.Text == "")
                    {
        ...
        private void CRUD_REGISTRO_AMONESTACION_Load(object sender, EventArgs e)
        {
