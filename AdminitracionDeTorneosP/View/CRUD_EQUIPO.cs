...
namespace AdminitracionDeTorneosP.View
{
    public partial class CRUD_EQUIPO : Form
    {
        ...
        {
            if(textNombreEquipo.Text == "" ||  textRepresentante.Text == "" || comboApellidoEntrenador.SelectedIndex<0 || comboNombreEntrenador.SelectedIndex<0)
            {
        ...
        private void CRUD_EQUIPO_Load(object sender, EventArgs e)
        {
