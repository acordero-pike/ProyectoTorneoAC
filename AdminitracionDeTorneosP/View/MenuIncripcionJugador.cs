...
namespace AdminitracionDeTorneosP.View
{
    public partial class MenuIncripcionJugador : Form
    {
        ...
        {
            if(comboBox2.SelectedIndex<0||comboBox1.SelectedIndex<0 || textBox1.Text==""||textBox2.Text=="")
            {
                MessageBox.Show($"Seleccione una opcin valida", "ALERTA", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void MenuIncripcionJugador_Load(object sender, EventArgs e)
        {
        ...
        {
            if (textBox1.Text==""  || textBox2.Text=="" ||comboBox2.SelectedIndex<0 || comboBox3.SelectedIndex<0)
            {
                button1.Enabled = false;
            }
            else
